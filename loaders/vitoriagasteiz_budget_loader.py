...
class BudgetCsvMapper:
    expenses_mapping = {
        '2018': {'ic_code': 0, 'fc_code': 1, 'full_ec_code': 2, 'description': 3, 'forecast_amount': 4, 'actual_amount': 7},
    }

    income_mapping = {
        '2018': {'full_ec_code': 0, 'description': 1, 'forecast_amount': 2, 'actual_amount': 5},
    }
