...
class BudgetCsvMapper:
    expenses_mapping = {
        ...
        '2020': {'ic_code': 0, 'fc_code': 1, 'full_ec_code': 2, 'description': 4, 'forecast_amount': 5, 'actual_amount': None},
    }
    ...
    income_mapping = {
        ...
        '2020': {'full_ec_code': 0, 'description': 1, 'forecast_amount': 2, 'actual_amount': None},
    }
